During the preparation for a meetup, I've collected lots of interesting resources about css-in-js that I would like to share with you. You can also find my presentations here and benchmarks of different css-in-js libraries.
...
* [Валерий Сорокобатько — CSS in JS. Зачем и почему?](https://www.youtube.com/watch?v=gfU17b8TFYU)
* [Артур Кенжаев — В поисках Стилевого Грааля](https://www.youtube.com/watch?v=b7vBKp8D0vs)
* [Виктория Тарасевич — Как покрасить забор, если он на React](https://www.youtube.com/watch?v=EwpnKU7xytI)
